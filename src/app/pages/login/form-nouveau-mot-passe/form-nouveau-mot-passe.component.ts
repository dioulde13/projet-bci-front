...
@Component({
  selector: 'app-form-nouveau-mot-passe',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule],
  templateUrl: './form-nouveau-mot-passe.component.html',
  styleUrls: ['./form-nouveau-mot-passe.component.css'],
})
export class FormNouveauMotPasseComponent implements OnInit {
  form!: FormGroup;
  message = '';
  success = false;
  loading = false;
